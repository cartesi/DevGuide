...
It's essential to have Windows Subsystem for Linux 2 (WSL2) installed and correctly configured to enjoy a seamless dApp development experience with Cartesi Rollups. WSL2 provides a Linux-like environment that aligns with the Cartesi ecosystem.
...
1. In the Ubuntu terminal (installed earlier with WSL) and run:
